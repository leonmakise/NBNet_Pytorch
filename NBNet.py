...
class NBNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.skip1 = nn.Sequential(ConvBlock(32, 32, strides=1),ConvBlock(32, 32, strides=1),ConvBlock(32, 32, strides=1),ConvBlock(32, 32, strides=1))
        self.ssa1 = SSA(64, strides=1)

        self.ConvBlock2 = ConvBlock(32, 64, strides=1)
        self.pool2 = nn.MaxPool2d(kernel_size=2)
        self.skip2 = nn.Sequential(ConvBlock(64, 64, strides=1),ConvBlock(64, 64, strides=1),ConvBlock(64, 64, strides=1))
